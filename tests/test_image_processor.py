...
class TestImageProcessor:
    ...
    def test_init_rectangular(self, sample_image_path):
        """Test initialization with rectangular grid."""
        processor = ImageProcessor(sample_image_path, grid_size=(2, 4))

        assert processor.grid_rows == 2
        assert processor.grid_cols == 4
        assert processor.total_pieces == 8
        assert processor.grid_size == (2, 4)
