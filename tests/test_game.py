...
class TestMetricsTracker:
    ...
    def test_max_correct_tracking(self):
        ...
        # Turn 1: improve
        tracker.record_turn(TurnResult(
            turn_number=1,
            moves_requested=[], moves_applied=[], moves_invalid=[],
            correct_before=5, correct_after=8,
        ))
        ...
        tracker.record_turn(TurnResult(
            turn_number=2,
            moves_requested=[], moves_applied=[], moves_invalid=[],
            correct_before=8, correct_after=6,
        ))
...
class TestPrompts:
    ...
    def test_build_user_prompt_basic(self):
        ...
        prompt = build_user_prompt(grid_size=8)
